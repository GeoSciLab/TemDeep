...
class CycleDataInterp(DataInterp):
    def __init__(self, args=None, root='', num_interp=7, sample_rate=1, step_size=1,
                 is_training=False, transform=None):
        super(CycleDataInterp, self).__init__(args=args, root=root, num_interp=num_interp, sample_rate=sample_rate,
